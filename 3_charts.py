...
] # this list contains the names of the CSV files for each class, which we will loop through to create the charts
...
plt.title("LST Trend Rokytka") # here changing name of the plot to reflect that it shows yearly means
plt.legend()
...
plt.xlabel("Year")
plt.ylabel("Warm Season Mean LST (°C)")
plt.title("Yearly Warm Season LST Trend  Rokytka") # here changing name of the plot to reflect that it shows yearly means
plt.legend()
plt.tight_layout()
plt.show()